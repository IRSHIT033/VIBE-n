...
var User = /** @class */ (function () {
    ...
    User.prototype.comparePasswords = function (hashPassword) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, bcrypt.compare(hashPassword, this.password)];
    ...
    __decorate([
        (0, typegoose_1.prop)({
            required: true,
            default: 'https://api-private.atlassian.com/users/8b3597e8a7d1d8f2ed7f58bcab1946b8/avatar',
        })
