...
var socketInit = function (server) {
    ...
    socketio.on('connection', function (socket) {
        socket.on('setup', function (user) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        socket.on('typing stopped', function (room) { return socket.to(room).emit('typing stopped'); });
    });
};
